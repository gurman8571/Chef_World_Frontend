  ...
  return (
    ...
    Connecting  {/* */}{" "}
      <span className="relative whitespace-nowrap text-blue-600">
        ...
        <span className="relative">chefs worldwide</span>
      </span>{" "}
      {/* */}Unite, Share, Elevate
    </h1>
    <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
    Connect with chefs worldwide to share your culinary creations, watch and post instructional videos, and collaborate to enhance each other's skills and knowledge.
    </p>
